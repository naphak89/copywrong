...
export default function LandingPage({ onNavigateToChat, selectedVideoId }: LandingPageProps) {
  ...
  return (
    <div className="bg-white relative w-full min-h-screen flex items-center justify-center overflow-hidden" data-name="iPhone 14 & 15 Pro - 2">
      <div className="relative h-[852px] w-[393px] max-w-full overflow-hidden mx-auto" data-name="Layer_1">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#022e21] to-[#012312]" data-name="Rectangle">
          {!imageError && (
        ...
        {/* 3D Wave Graphic */}
        <div className="absolute h-[301px] left-[-66px] top-[239px] w-[527px] pointer-events-none" data-name="image 4">
          <img 
            alt="" 
        ...
        <div className="absolute left-[4.07%] right-[4.07%] top-[45px] bottom-0" data-name="content-container">
          ...
          <div className="absolute top-[5.28%] right-0" data-name="settings-button">
          ...
          <div className="absolute top-[15.73%] left-[8.91%] right-[8.65%] text-center">
            <p className="bg-clip-text bg-gradient-to-r font-['Inter',sans-serif] font-normal from-white/60 leading-normal not-italic text-[26px] text-center to-white/80 via-white via-[52.404%] mb-0" style={{ WebkitTextFillColor: 'transparent' }}>
              Hello, User Persona!
            </p>
            <p className="bg-clip-text bg-gradient-to-r font-['Inter',sans-serif] font-normal from-white/60 leading-normal not-italic text-[26px] text-center to-white/80 via-white via-[52.404%] mt-0" style={{ WebkitTextFillColor: 'transparent' }}>
          ...
          <div className="absolute top-[86.03%] left-0 right-0" data-name="input-bar">
